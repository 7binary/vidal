...
class FtpImplicitSsl
{
     ...
     */
    public function __construct($username, $password, $server, $port = 990, $initial_path = '', $passive_mode = false, $cert = null)
    {
        $this->cert = $cert;
...
//        curl_setopt($this->curl_handle, CURLOPT_CAINFO, $this->cert);
