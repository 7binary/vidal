	...
	function load(settings, root, child, container) {
		...
		function createNode(parent) {
			...
			var current = this.countProducts
				? $("<li/>").attr("id", this.id || "").html('<span class="t">' + this.code + '</span>' + "<span>" + '<a itemprop="url" target="blank" href="/drugs/atc/' + this.code.toLowerCase() + '">' + this.text + '</a>' + "</span>").appendTo(parent)
