...
function load(settings, root, child, container) {
	function createNode(parent) {
		...
		var current = this.countProducts
			? $("<li/>").attr("id", this.id || "").html('<span class="t">' + this.id + '</span>' + "<span>" + '<a itemprop="url" target="blank" href="/drugs/clinic-pointer/' + this.id.toLowerCase() + '">' + this.text + '</a>' + "</span>").appendTo(parent)
