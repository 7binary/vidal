...
class AudioController extends Controller
{
    ...
    /**
     * @Route("/big-mama/audio", name="big_mama_audio", options={"expose"=true})
    ...
    public function publicationsAction(Request $request)
    {
        ...
        if ($page == 1) {
            return $this->redirect($this->generateUrl('big_mama_audio'), 301);
        }elseif ($page == null) {
            $page = 1;
        }
        ...
        $pagination = $paginator->paginate(
            $em->getRepository(Audio::class)->findActive(false),
            $page,
        ...
        $params['page'] = $page;
        $params['isPromo'] = true;
        $params['publication_route'] = 'big_mama_audio';
        $params['publication_item_route'] = 'big_mama_audio_item';
        $params['publication_edit_route'] = 'admin_vidal_bigmama_audio_edit';
        $params['publication_more'] = '/big-mama/audio/more/';
        return $params;
    }

    /**
     * @Route("/big-mama/audio/{link}", name="big_mama_audio_item")
    ...
    public function publicationAction(Request $request, $link)
    {
        ...
        $em = $this->getDoctrine()->getManager('big_mama');
        $publication = $em->getRepository(Audio::class)->findOneByLink($link);
        ...
        return array(
            ...
            'all_items_route' => 'big_mama_audio',
            'all_items_title' => 'Другие аудио',
            'publication_edit_route' => 'admin_vidal_bigmama_audio_edit'
        );
    }

    /**
     * @Route("/big-mama/audio/more/{currPage}", name="big_mama_audio_more", options={"expose"=true})
    ...
    public function moreNewsAction(Request $request, $currPage)
    {
        ...
        $publications = $em->getRepository(Audio::class)
        ...
        $html = $this->renderView('VidalBigMamaBundle:Publication:more.html.twig', array(
            ...
            'publication_item_route' => 'big_mama_audio_item',
            'publication_edit_route' => 'admin_vidal_bigmama_audio_edit'
        ));
