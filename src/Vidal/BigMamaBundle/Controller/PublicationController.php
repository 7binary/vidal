...
class PublicationController extends Controller
{
    ...
    /**
     * @Route("/big-mama/publications", name="big_mama_publication", options={"expose"=true})
    ...
    public function publicationsAction(Request $request)
    {
        ...
        if ($page == 1) {
            return $this->redirect($this->generateUrl('big_mama_publication'), 301);
        }elseif ($page == null) {
            $page = 1;
        }
        ...
        $pagination = $paginator->paginate(
            $em->getRepository(Publication::class)->findActive(false),
            $page,
        ...
        $params['page'] = $page;
        $params['isPromo'] = true;
        $params['publication_route'] = 'big_mama_publication';
        $params['publication_item_route'] = 'big_mama_publication_item';
        $params['publication_edit_route'] = 'admin_vidal_bigmama_publication_edit';
        $params['publication_more'] = '/big-mama/publications/more/';
        return $params;
    }

    /**
     * @Route("/big-mama/publication/{link}", name="big_mama_publication_item")
    ...
    public function publicationAction(Request $request, $link)
    {
        ...
        $em = $this->getDoctrine()->getManager('big_mama');
        $publication = $em->getRepository(Publication::class)->findOneByLink($link);
        ...
        return array(
            ...
            'all_items_route' => 'big_mama_publication',
            'all_items_title' => 'Другие статьи',
            'publication_edit_route' => 'admin_vidal_bigmama_publication_edit'
        );
    }

    /**
     * @Route("/big-mama/publications/more/{currPage}", name="big_mama_publication_more", options={"expose"=true})
    ...
    public function moreNewsAction(Request $request, $currPage)
    {
        ...
        $html = $this->renderView('VidalBigMamaBundle:Publication:more.html.twig', array(
            ...
            'publication_item_route' => 'big_mama_publication_item',
            'publication_edit_route' => 'admin_vidal_bigmama_publication_edit'
        ));
