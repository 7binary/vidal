...
namespace Vidal\BigMamaBundle\Command;
...
class PublicationLinkCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName('big_mama:publication_link');
    }

    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ini_set('memory_limit', -1);
        $output->writeln('--- big_mama:publication_link started');
        ...
        $output->writeln("+++ big_mama:publication_link completed!");
    }
