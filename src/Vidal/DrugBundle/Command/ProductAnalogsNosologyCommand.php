...
class ProductAnalogsNosologyCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this->setName('vidal:product_analogs_nosology')
            ->setDescription('Formats product_analogs_nosology');
    }

    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ini_set('memory_limit', -1);
        $output->writeln('--- vidal:product_analogs_nosology started');
        ...
        $updateQuery = $em->createQuery("UPDATE VidalDrugBundle:Product p SET p.analogsNosology = :analogs WHERE p = :ProductID");
        ...
        $output->writeln("+++ vidal:product_analogs_nosology completed!");
    }
}